...
- **Get a PR through CI:** see `docs/splice-ci.md`: the CI gates (`[ci]`/DCO/release-line), the Daml static checks (warts, docs), the Stale-file-handle flake, and the PR/git workflow.
